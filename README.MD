...
5. Para que a imagem do cachorro ficasse boa, foi necessario redimensiona-la no css, aprendi pesquisando no google, para tal visualizar tal feito procure por #profile img
